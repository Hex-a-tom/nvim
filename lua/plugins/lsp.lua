return {
	...
	},
	{
		...
		config = function (_, opts)
			vim.api.nvim_set_hl(0, "NavicIconsFile",          {default = false, bg = "#272A39", fg = "#7E8294"})
			vim.api.nvim_set_hl(0, "NavicIconsModule",        {default = false, bg = "#272A39", fg = "#Ae77Bf"})
			vim.api.nvim_set_hl(0, "NavicIconsNamespace",     {default = false, bg = "#272A39", fg = "#Ae77Bf"})
			vim.api.nvim_set_hl(0, "NavicIconsPackage",       {default = false, bg = "#272A39", fg = "#Ae77Bf"})
			vim.api.nvim_set_hl(0, "NavicIconsClass",         {default = false, bg = "#272A39", fg = "#ae77bf"})
			vim.api.nvim_set_hl(0, "NavicIconsMethod",        {default = false, bg = "#272A39", fg = "#6c8ed4"})
			vim.api.nvim_set_hl(0, "NavicIconsProperty",      {default = false, bg = "#272A39", fg = "#b5585f"})
			vim.api.nvim_set_hl(0, "NavicIconsField",         {default = false, bg = "#272A39", fg = "#b5585f"})
			vim.api.nvim_set_hl(0, "NavicIconsConstructor",   {default = false, bg = "#272A39", fg = "#d4bb6c"})
			vim.api.nvim_set_hl(0, "NavicIconsEnum",          {default = false, bg = "#272A39", fg = "#9fbf73"})
			vim.api.nvim_set_hl(0, "NavicIconsInterface",     {default = false, bg = "#272A39", fg = "#58b5a8"})
			vim.api.nvim_set_hl(0, "NavicIconsFunction",      {default = false, bg = "#272A39", fg = "#a377bf"})
			vim.api.nvim_set_hl(0, "NavicIconsVariable",      {default = false, bg = "#272A39", fg = "#7e8294"})
			vim.api.nvim_set_hl(0, "NavicIconsConstant",      {default = false, bg = "#272A39", fg = "#d4bb6c"})
			vim.api.nvim_set_hl(0, "NavicIconsString",        {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsNumber",        {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsBoolean",       {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsArray",         {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsObject",        {default = false, bg = "#272A39", fg = "#a377bf"})
			vim.api.nvim_set_hl(0, "NavicIconsKey",           {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsNull",          {default = false, bg = "#272A39", fg = "#9fbd73"})
			vim.api.nvim_set_hl(0, "NavicIconsEnumMember",    {default = false, bg = "#272A39", fg = "#6c8ed4"})
			vim.api.nvim_set_hl(0, "NavicIconsStruct",        {default = false, bg = "#272A39", fg = "#a377bf"})
			vim.api.nvim_set_hl(0, "NavicIconsEvent",         {default = false, bg = "#272A39", fg = "#b5585f"})
			vim.api.nvim_set_hl(0, "NavicIconsOperator",      {default = false, bg = "#272A39", fg = "#a377bf"})
			vim.api.nvim_set_hl(0, "NavicIconsTypeParameter", {default = false, bg = "#272A39", fg = "#58b5a8"})
